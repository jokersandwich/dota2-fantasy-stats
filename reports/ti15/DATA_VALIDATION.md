...
|---|---:|---:|---:|---:|---:|---:|
| `kills` | 590 | 0 | 0 | 31 | 0 | 3317 |
| `deaths` | 590 | 0 | 0 | 20 | 0 | 1950 |
| `creep_score` | 590 | 0 | 14 | 1414 | 42 | 4242 |
| `gpm` | 590 | 0 | 171 | 1100 | 342 | 2200 |
| `madstones` | 0 | 590 | — | — | — | — |
| `tower_kills` | 590 | 0 | 0 | 10 | 0 | 3520 |
| `observer_wards` | 590 | 0 | 0 | 36 | 0 | 4212 |
| `camps_stacked` | 590 | 0 | 0 | 15 | 0 | 3510 |
| `rune_pickups` | 590 | 0 | 0 | 21 | 0 | 2961 |
| `watchers` | 0 | 590 | — | — | — | — |
| `lotuses` | 0 | 590 | — | — | — | — |
| `roshan_kills` | 590 | 0 | 0 | 3 | 0 | 3516 |
| `teamfight_participation` | 590 | 0 | 0 | 1 | 0 | 2124 |
| `stun_duration` | 589 | 1 | 0 | 434.8766 | 0 | 4348.766 |
| `tormentor_kills` | 590 | 0 | 0 | 3 | 0 | 2637 |
| `courier_kills` | 590 | 0 | 0 | 8 | 0 | 5624 |
| `first_blood` | 580 | 10 | 0 | 1 | 0 | 1934 |
| `smokes` | 590 | 0 | 0 | 13 | 0 | 3809 |

## 发现的问题与处理

### 1. 眩晕时间负值

OpenDota 原始数据中有 1 条被隔离的非法原始值：match `8943148045`、tOfu（account_id `16497807`）、`stun_duration` 原值 `-5.1832275`。计分引擎没有将其归零，也没有产生负分；该指标的 `rawValue` 和 `baseFantasyScore` 均输出为 `null`，`dataAvailability` 为 `unavailable`。
